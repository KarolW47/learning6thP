        ...
        while (isStillRunning) {
            ...
            while (stillCheckingForUsersCategoryPick) {
                ...
                switch (chosenQuizCategory) {
                    case 1 -> {
                        obtainedPointsInQuiz = qaHandler.handleQuestionsAndAnswers(AvailableCategories.FILM);
                        System.out.println("You obtained " + obtainedPointsInQuiz + "/5 points");
                    }
                    case 2 -> {
                        obtainedPointsInQuiz = qaHandler.handleQuestionsAndAnswers(AvailableCategories.SPORT);
                        System.out.println("You obtained " + obtainedPointsInQuiz + "/5 points");
                    }
                }
